...
它不依赖手机 companion app。当前版本的目标很明确：用户通过“手表出二维码、手机扫码导入”的方式导入播客，然后在小屏设备上完成浏览、播放和离线收听。

## 预览

| 首页 | 订阅 | 播客详情 |
| --- | --- | --- |
| ![WearPod 首页预览](./docs/assets/wearpod-home.png) | ![WearPod 订阅页预览](./docs/assets/wearpod-subscriptions.png) | ![WearPod 播客详情页预览](./docs/assets/wearpod-detail.png) |

| 播放器 | 当前队列 | 离线 |
| --- | --- | --- |
| ![WearPod 播放器预览](./docs/assets/wearpod-player.png) | ![WearPod 当前队列预览](./docs/assets/wearpod-queue.png) | ![WearPod 离线页预览](./docs/assets/wearpod-downloads.png) |
